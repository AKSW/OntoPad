...
var n = /* @__PURE__ */ new Uint8Array(16);
function r() {
...
function i(e, t, n) {
	return !t && !e && crypto.randomUUID ? crypto.randomUUID() : a(e, t, n);
}
function a(e, n, i) {
	e ||= {};
	let a = e.random ?? e.rng?.() ?? r();
	if (a.length < 16) throw Error("Random bytes length must be >= 16");
	if (a[6] = a[6] & 15 | 64, a[8] = a[8] & 63 | 128, n) {
		if (i ||= 0, i < 0 || i + 16 > n.length) throw RangeError(`UUID byte range ${i}:${i + 15} is out of buffer bounds`);
