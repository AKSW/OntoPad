import { n as e, r as t, t as n } from "./plugin-ngb8Wl3B.js";
import { createPinia as r } from "pinia";
...
var a = Symbol.for("yaml.alias"), o = Symbol.for("yaml.document"), s = Symbol.for("yaml.map"), c = Symbol.for("yaml.pair"), l = Symbol.for("yaml.scalar"), u = Symbol.for("yaml.seq"), d = Symbol.for("yaml.node.type"), f = (e) => !!e && typeof e == "object" && e[d] === a, p = (e) => !!e && typeof e == "object" && e[d] === o, m = (e) => !!e && typeof e == "object" && e[d] === s, h = (e) => !!e && typeof e == "object" && e[d] === c, g = (e) => !!e && typeof e == "object" && e[d] === l, _ = (e) => !!e && typeof e == "object" && e[d] === u;
function v(e) {
...
var b = (e) => (g(e) || v(e)) && !!e.anchor, x = Symbol("break visit"), S = Symbol("skip children"), C = Symbol("remove node");
function w(e, t) {
	let n = ee(t);
	p(e) ? T(null, e.contents, n, Object.freeze([e])) === C && (e.contents = null) : T(null, e, n, Object.freeze([]));
}
w.BREAK = x, w.SKIP = S, w.REMOVE = C;
function T(e, t, n, r) {
	let i = te(e, t, n, r);
	if (y(i) || h(i)) return ne(e, r, i), T(e, i, n, r);
	if (typeof i != "symbol") {
		if (v(t)) {
			r = Object.freeze(r.concat(t));
			for (let e = 0; e < t.items.length; ++e) {
				let i = T(e, t.items[e], n, r);
				if (typeof i == "number") e = i - 1;
				else if (i === x) return x;
				else i === C && (t.items.splice(e, 1), --e);
			}
		} else if (h(t)) {
			r = Object.freeze(r.concat(t));
			let e = T("key", t.key, n, r);
			if (e === x) return x;
			e === C && (t.key = null);
			let i = T("value", t.value, n, r);
			if (i === x) return x;
			i === C && (t.value = null);
		}
	}
...
async function E(e, t) {
	let n = ee(t);
	p(e) ? await D(null, e.contents, n, Object.freeze([e])) === C && (e.contents = null) : await D(null, e, n, Object.freeze([]));
}
E.BREAK = x, E.SKIP = S, E.REMOVE = C;
async function D(e, t, n, r) {
	let i = await te(e, t, n, r);
	if (y(i) || h(i)) return ne(e, r, i), D(e, i, n, r);
	if (typeof i != "symbol") {
		if (v(t)) {
			r = Object.freeze(r.concat(t));
			for (let e = 0; e < t.items.length; ++e) {
				let i = await D(e, t.items[e], n, r);
				if (typeof i == "number") e = i - 1;
				else if (i === x) return x;
				else i === C && (t.items.splice(e, 1), --e);
			}
			...
			r = Object.freeze(r.concat(t));
			let e = await D("key", t.key, n, r);
			if (e === x) return x;
			e === C && (t.key = null);
			let i = await D("value", t.value, n, r);
			if (i === x) return x;
			i === C && (t.value = null);
		}
	}
...
function te(e, t, n, r) {
	...
	if (m(t)) return n.Map?.(e, t, r);
	if (_(t)) return n.Seq?.(e, t, r);
	if (h(t)) return n.Pair?.(e, t, r);
	if (g(t)) return n.Scalar?.(e, t, r);
	if (f(t)) return n.Alias?.(e, t, r);
}
function ne(e, t, n) {
	let r = t[t.length - 1];
	if (v(r)) r.items[e] = n;
	else if (h(r)) e === "key" ? r.key = n : r.value = n;
	else if (p(r)) r.contents = n;
	else {
		let e = f(r) ? "alias" : "scalar";
...
var re = {
	...
	"{": "%7B",
	"}": "%7D"
}, ie = (e) => e.replace(/[!,[\]{}]/g, (e) => re[e]), O = class e {
	constructor(t, n) {
	...
	tagString(e) {
		for (let [t, n] of Object.entries(this.tags)) if (e.startsWith(n)) return t + ie(e.substring(n.length));
		return e[0] === "!" ? e : `!<${e}>`;
	}
	toString(e) {
		let t = this.yaml.explicit ? [`%YAML ${this.yaml.version || "1.2"}`] : [], n = Object.entries(this.tags), r;
		if (e && n.length > 0 && y(e.contents)) {
			let t = {};
			w(e.contents, (e, n) => {
				y(n) && n.tag && (t[n.tag] = !0);
			}), r = Object.keys(t);
...
function ce(e, t) {
	...
	return {
		...
		setAnchors: () => {
			for (let e of n) {
				let t = r.get(e);
				if (typeof t == "object" && t.anchor && (g(t.node) || v(t.node))) t.node.anchor = t.anchor;
				else {
...
var le = class {
	...
	toJS(e, { mapAsMap: t, maxAliasCount: n, onAnchor: r, reviver: i } = {}) {
		...
		return typeof i == "function" ? k(i, { "": o }, "", o) : o;
	}
}, ue = class extends le {
	constructor(e) {
		super(a), this.source = e, Object.defineProperty(this, "tag", { set() {
	...
	resolve(e, t) {
		...
		let n;
		t?.aliasResolveCache ? n = t.aliasResolveCache : (n = [], w(e, { Node: (e, t) => {
			(f(t) || b(t)) && n.push(t);
	...
	toJSON(e, t) {
		...
		let o = n.get(a);
		/* istanbul ignore if */
		if (o ||= (A(a, null, t), n.get(a)), o?.res === void 0) throw ReferenceError("This should not happen: Alias anchor was not resolved?");
		if (i >= 0 && (o.count += 1, o.aliasCount === 0 && (o.aliasCount = de(r, a, n)), o.count * o.aliasCount > i)) throw ReferenceError("Excessive alias count indicates a resource exhaustion attack");
		return o.res;
	}
	toString(e, t, n) {
		let r = `*${this.source}`;
		if (e) {
			if (ae(this.source), e.options.verifyAliasOrder && !e.anchors.has(this.source)) {
				let e = `Unresolved alias (the anchor must be set before the alias): ${this.source}`;
				throw Error(e);
			}
...
function de(e, t, n) {
	if (f(t)) {
		...
		let r = de(e, t.key, n), i = de(e, t.value, n);
		return Math.max(r, i);
	}
	return 1;
}
...
var fe = (e) => !e || typeof e != "function" && typeof e != "object", j = class extends le {
	constructor(e) {
...
j.BLOCK_FOLDED = "BLOCK_FOLDED", j.BLOCK_LITERAL = "BLOCK_LITERAL", j.PLAIN = "PLAIN", j.QUOTE_DOUBLE = "QUOTE_DOUBLE", j.QUOTE_SINGLE = "QUOTE_SINGLE";
//#endregion
//#region node_modules/yaml/browser/dist/doc/createNode.js
var pe = "tag:yaml.org,2002:";
function me(e, t, n) {
	if (t) {
...
function M(e, t, n) {
	if (p(e) && (e = e.contents), y(e)) return e;
	if (h(e)) {
		let t = n.schema[s].createNode?.(n.schema, null, n);
	...
	let { aliasDuplicateObjects: r, onAnchor: i, onTagObj: a, schema: o, sourceObjects: c } = n, l;
	if (r && e && typeof e == "object") {
		if (l = c.get(e), l) return l.anchor ??= i(e), new ue(l.anchor);
		l = {
			anchor: null,
			node: null
		}, c.set(e, l);
	}
	t?.startsWith("!!") && (t = pe + t.slice(2));
	let d = me(e, t, o.tags);
	if (!d) {
		...
		d = e instanceof Map ? o[s] : Symbol.iterator in Object(e) ? o[u] : o[s];
	}
	a && (a(d), delete n.onTagObj);
	let f = d?.createNode ? d.createNode(n.schema, e, n) : typeof d?.nodeClass?.from == "function" ? d.nodeClass.from(n.schema, e, n) : new j(e);
	return t ? f.tag = t : d.default || (f.tag = d.tag), l && (l.node = f), f;
}
//#endregion
...
var ge = (e) => e == null || typeof e == "object" && !!e[Symbol.iterator]().next().done, _e = class extends le {
	constructor(e, t) {
	...
	clone(e) {
		...
		return e && (t.schema = e), t.items = t.items.map((t) => y(t) || h(t) ? t.clone(e) : t), this.range && (t.range = this.range.slice()), t;
	}
	addIn(e, t) {
		if (ge(e)) this.add(t);
		else {
			...
			if (v(i)) i.addIn(r, t);
			else if (i === void 0 && this.schema) this.set(n, he(this.schema, r, t));
	...
	getIn(e, t) {
		let [n, ...r] = e, i = this.get(n, !0);
		return r.length === 0 ? !t && g(i) ? i.value : i : v(i) ? i.getIn(r, t) : void 0;
	}
	hasAllNullValues(e) {
	...
	setIn(e, t) {
		...
		if (r.length === 0) this.set(n, t);
			...
			let e = this.get(n, !0);
			if (v(e)) e.setIn(r, t);
			else if (e === void 0 && this.schema) this.set(n, he(this.schema, r, t));
			else throw Error(`Expected YAML collection at ${n}. Remaining path: ${r}`);
		}
	}
}, ve = (e) => e.replace(/^(?!$)(?: $)?/gm, "#");
...
var P = (e, t, n) => e.endsWith("\n") ? N(n, t) : n.includes("\n") ? "\n" + N(n, t) : (e.endsWith(" ") ? "" : " ") + n, ye = "flow", be = "block", xe = "quoted";
...
function ke({ comment: e, type: t, value: n }, r, i, a) {
	let { blockQuote: o, commentString: s, lineWidth: c } = r.options;
	if (!o || /\n[\t ]+$/.test(n)) return I(n, r);
	let l = r.indent || (r.forceBlockIndent || Te(n) ? "  " : ""), u = o === "literal" ? !0 : o === "folded" || t === j.BLOCK_FOLDED ? !1 : t === j.BLOCK_LITERAL || !Ee(n, c, l.length);
	if (!n) return u ? "|\n" : ">\n";
	let d, f;
	...
	if (e && (y += " " + s(e.replace(/ ?[\r\n]+/g, " ")), i && i()), !u) {
		let e = n.replace(/\n+/g, "\n$&").replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g, "$1$2").replace(/\n+/g, `$&${l}`), i = !1, a = we(r, !0);
		o !== "folded" && t !== j.BLOCK_FOLDED && (a.onOverflow = () => {
			i = !0;
		});
...
function Ae(e, t, n, r) {
	...
	if (!s && !u && i !== j.PLAIN && a.includes("\n")) return ke(e, t, n, r);
	if (Te(a)) {
		if (c === "") return t.forceBlockIndent = !0, ke(e, t, n, r);
...
function je(e, t, n, r) {
	...
	s !== j.QUOTE_DOUBLE && /[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o.value) && (s = j.QUOTE_DOUBLE);
	let c = (e) => {
		switch (e) {
			case j.BLOCK_FOLDED:
			case j.BLOCK_LITERAL: return i || a ? I(o.value, t) : ke(o, t, n, r);
			case j.QUOTE_DOUBLE: return F(o.value, t);
			case j.QUOTE_SINGLE: return De(o.value, t);
			case j.PLAIN: return Ae(o, t, n, r);
			default: return null;
		}
	}, l = c(s);
	if (l === null) {
...
function Pe(e, t, { anchors: n, doc: r }) {
	if (!r.directives) return "";
	let i = [], a = (g(e) || v(e)) && e.anchor;
	a && ae(a) && (n.add(a), i.push(`&${a}`));
	let o = e.tag ?? (t.default ? null : t.tag);
	return o && i.push(r.directives.tagString(o)), i.join(" ");
}
function L(e, t, n, r) {
	if (h(e)) return e.toString(t, n, r);
	if (f(e)) {
	...
	let i, a = y(e) ? e : t.doc.createNode(e, { onTagObj: (e) => i = e });
	i ??= Ne(t.doc.schema.tags, a);
	let o = Pe(a, i, t);
	o.length > 0 && (t.indentAtStart = (t.indentAtStart ?? 0) + o.length + 1);
	let s = typeof i.stringify == "function" ? i.stringify(a, t, n, r) : g(a) ? je(a, t, n, r) : a.toString(t, n, r);
	return o ? g(a) || s[0] === "{" || s[0] === "[" ? `${o} ${s}` : `${o}\n${t.indent}${s}` : s;
}
//#endregion
//#region node_modules/yaml/browser/dist/stringify/stringifyPair.js
function Fe({ key: e, value: t }, n, r, i) {
	let { allNullValues: a, doc: o, indent: s, indentStep: c, options: { commentString: l, indentSeq: u, simpleKeys: d } } = n, f = y(e) && e.comment || null;
	if (d) {
		if (f) throw Error("With simple keys, key nodes cannot have comments");
		if (v(e) || !y(e) && typeof e == "object") throw Error("With simple keys, collection cannot be used as a key value");
	}
	let p = !d && (!e || f && t == null && !n.inFlow || v(e) || (g(e) ? e.type === j.BLOCK_FOLDED || e.type === j.BLOCK_LITERAL : typeof e == "object"));
	n = Object.assign({}, n, {
		allNullValues: !1,
		implicitKey: !p && (d || !a),
		indent: s + c
	});
	let m = !1, h = !1, b = L(e, n, () => m = !0, () => h = !0);
	if (!p && !n.inFlow && b.length > 1024) {
		if (d) throw Error("With simple keys, single line scalar must not span more than 1024 characters");
		p = !0;
	}
	if (n.inFlow) {
		if (a || t == null) return m && r && r(), b === "" ? "?" : p ? `? ${b}` : b;
	} else if (a && !d || t == null && p) return b = `? ${b}`, f && !m ? b += P(b, n.indent, l(f)) : h && i && i(), b;
	m && (f = null), p ? (f && (b += P(b, n.indent, l(f))), b = `? ${b}\n${s}:`) : (b = `${b}:`, f && (b += P(b, n.indent, l(f))));
	let x, S, C;
	y(t) ? (x = !!t.spaceBefore, S = t.commentBefore, C = t.comment) : (x = !1, S = null, C = null, t && typeof t == "object" && (t = o.createNode(t))), n.implicitKey = !1, !p && !f && g(t) && (n.indentAtStart = b.length + 1), h = !1, !u && c.length >= 2 && !n.inFlow && !p && _(t) && !t.flow && !t.tag && !t.anchor && (n.indent = n.indent.substring(2));
	let w = !1, T = L(t, n, () => w = !0, () => h = !0), E = " ";
	if (f || x || S) {
		if (E = x ? "\n" : "", S) {
			let e = l(S);
			E += `\n${N(e, n.indent)}`;
	...
	return b += E + T, n.inFlow ? w && r && r() : C && !w ? b += P(b, n.indent, l(C)) : h && i && i(), b;
}
//#endregion
...
var Le = "<<", R = {
	identify: (e) => e === Le || typeof e == "symbol" && e.description === Le,
	default: "key",
	tag: "tag:yaml.org,2002:merge",
	test: /^<<$/,
	resolve: () => Object.assign(new j(Symbol(Le)), { addToJSMap: ze }),
	stringify: () => Le
}, Re = (e, t) => (R.identify(t) || g(t) && (!t.type || t.type === j.PLAIN) && R.identify(t.value)) && e?.doc.schema.tags.some((e) => e.tag === R.tag && e.default);
function ze(e, t, n) {
	let r = Ve(e, n);
	if (_(r)) for (let n of r.items) Be(e, t, n);
	else if (Array.isArray(r)) for (let n of r) Be(e, t, n);
	else Be(e, t, r);
}
function Be(e, t, n) {
	let r = Ve(e, n);
	if (!m(r)) throw Error("Merge sources must be maps or map aliases");
...
function Ve(e, t) {
	return e && f(t) ? t.resolve(e.doc, e) : t;
}
//#endregion
//#region node_modules/yaml/browser/dist/nodes/addPairToJSMap.js
function He(e, t, { key: n, value: r }) {
	if (y(n) && n.addToJSMap) n.addToJSMap(e, t, r);
	else if (Re(e, n)) ze(e, t, r);
	else {
		let i = A(n, "", e);
		if (t instanceof Map) t.set(i, A(r, i, e));
		else if (t instanceof Set) t.add(i);
		else {
			let a = Ue(n, i, e), o = A(r, a, e);
...
function Ue(e, t, n) {
	...
	if (y(e) && n?.doc) {
		...
		if (!n.mapKeyWarned) {
			...
			e.length > 40 && (e = e.substring(0, 36) + "...\""), Ie(n.doc.options.logLevel, `Keys with collection values will be stringified due to JS Object restrictions: ${e}. Set mapAsMap: true to use object keys.`), n.mapKeyWarned = !0;
		}
		return r;
	}
...
function We(e, t, n) {
	return new z(M(e, void 0, n), M(t, void 0, n));
}
var z = class e {
	constructor(e, t = null) {
		Object.defineProperty(this, d, { value: c }), this.key = e, this.value = t;
	}
	clone(t) {
		let { key: n, value: r } = this;
		return y(n) && (n = n.clone(t)), y(r) && (r = r.clone(t)), new e(n, r);
	}
	toJSON(e, t) {
		return He(t, t?.mapAsMap ? /* @__PURE__ */ new Map() : {}, this);
	}
	toString(e, t, n) {
		return e?.doc ? Fe(this, e, t, n) : JSON.stringify(this);
	}
};
//#endregion
//#region node_modules/yaml/browser/dist/stringify/stringifyCollection.js
function Ge(e, t, n) {
	return (t.inFlow ?? e.flow ? qe : Ke)(e, t, n);
}
function Ke({ comment: e, items: t }, n, { blockItemPrefix: r, flowChars: i, itemIndent: a, onChompKeep: o, onComment: s }) {
	...
	for (let e = 0; e < t.length; ++e) {
		let i = t[e], o = null;
		if (y(i)) !d && i.spaceBefore && f.push(""), Je(n, f, i.commentBefore, d), i.comment && (o = i.comment);
		else if (h(i)) {
			let e = y(i.key) ? i.key : null;
			e && (!d && e.spaceBefore && f.push(""), Je(n, f, e.commentBefore, d));
		}
		d = !1;
		let s = L(i, u, () => o = null, () => d = !0);
		o && (s += P(s, a, l(o))), d && o && (d = !1), f.push(r + s);
	}
	let p;
...
function qe({ items: e }, t, { flowChars: n, itemIndent: r }) {
	...
	for (let n = 0; n < e.length; ++n) {
		let i = e[n], a = null;
		if (y(i)) i.spaceBefore && d.push(""), Je(t, d, i.commentBefore, !1), i.comment && (a = i.comment);
		else if (h(i)) {
			let e = y(i.key) ? i.key : null;
			e && (e.spaceBefore && d.push(""), Je(t, d, e.commentBefore, !1), e.comment && (l = !0));
			let n = y(i.value) ? i.value : null;
...
function Je({ indent: e, options: { commentString: t } }, n, r, i) {
	if (r && i && (r = r.replace(/^\n+/, "")), r) {
		let i = N(t(r), e);
		n.push(i.trimStart());
	}
...
function B(e, t) {
	let n = g(t) ? t.value : t;
	for (let r of e) if (h(r) && (r.key === t || r.key === n || g(r.key) && r.key.value === n)) return r;
}
var V = class extends _e {
	static get tagName() {
	...
	static from(e, t, n) {
		let { keepUndefined: r, replacer: i } = n, a = new this(e), o = (e, o) => {
			...
			(o !== void 0 || r) && a.items.push(We(e, o, n));
		};
	...
	add(e, t) {
		let n;
		n = h(e) ? e : !e || typeof e != "object" || !("key" in e) ? new z(e, e?.value) : new z(e.key, e.value);
		let r = B(this.items, n.key), i = this.schema?.sortMapEntries;
		if (r) {
			if (!t) throw Error(`Key ${n.key} already set`);
			g(r.value) && fe(n.value) ? r.value.value = n.value : r.value = n.value;
		} else if (i) {
	...
	toJSON(e, t, n) {
		...
		for (let e of this.items) He(t, r, e);
		return r;
	}
	toString(e, t, n) {
		if (!e) return JSON.stringify(this);
		for (let e of this.items) if (!h(e)) throw Error(`Map items must all be pairs; found ${JSON.stringify(e)} instead`);
		return !e.allNullValues && this.hasAllNullValues(!1) && (e = Object.assign({}, e, { allNullValues: !0 })), Ge(this, e, {
			blockItemPrefix: "",
			flowChars: {
				start: "{",
				end: "}"
	...
	resolve(e, t) {
		return m(e) || t("Expected a mapping for this tag"), e;
	},
	...
	set(e, t) {
		...
		let r = this.items[n];
		g(r) && fe(t) ? r.value = t : this.items[n] = t;
	}
	toJSON(e, t) {
		let n = [];
...
var W = {
	...
	resolve: (e) => e,
	stringify(e, t, n, r) {
		return t = Object.assign({ actualString: !0 }, t), je(e, t, n, r);
	}
}, Ze = {
	identify: (e) => e == null,
	...
	test: /^(?:~|[Nn]ull|NULL)?$/,
	resolve: () => new j(null),
	stringify: ({ source: e }, t) => typeof e == "string" && Ze.test.test(e) ? e : t.options.nullStr
}, Qe = {
	...
	stringify({ source: e, value: t }, n) {
		return e && Qe.test.test(e) && t === (e[0] === "t" || e[0] === "T") ? e : t ? n.options.trueStr : n.options.falseStr;
	}
};
//#endregion
...
var $e = {
	...
	test: /^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,
	resolve(e) {
		let t = new j(parseFloat(e)), n = e.indexOf(".");
		return n !== -1 && e[e.length - 1] === "0" && (t.minFractionDigits = e.length - n - 1), t;
	},
	stringify: G
}, nt = (e) => typeof e == "bigint" || Number.isInteger(e), rt = (e, t, n, { intAsBigInt: r }) => r ? BigInt(e) : parseInt(e.substring(t), n);
function it(e, t, n) {
	let { value: r } = e;
	return nt(r) && r >= 0 ? n + r.toString(t) : G(e);
}
var at = {
	identify: (e) => nt(e) && e >= 0,
	default: !0,
	...
	format: "OCT",
	test: /^0o[0-7]+$/,
	resolve: (e, t, n) => rt(e, 2, 8, n),
	stringify: (e) => it(e, 8, "0o")
}, ot = {
	identify: nt,
	default: !0,
	tag: "tag:yaml.org,2002:int",
	test: /^[-+]?[0-9]+$/,
	resolve: (e, t, n) => rt(e, 0, 10, n),
	stringify: G
}, st = {
	identify: (e) => nt(e) && e >= 0,
	default: !0,
	...
	format: "HEX",
	test: /^0x[0-9a-fA-F]+$/,
	resolve: (e, t, n) => rt(e, 2, 16, n),
	stringify: (e) => it(e, 16, "0x")
}, ct = [
	H,
	W,
	Xe,
...
var ut = ({ value: e }) => JSON.stringify(e), dt = [
	{
		identify: (e) => typeof e == "string",
		default: !0,
		tag: "tag:yaml.org,2002:str",
	...
	},
	{
		...
		stringify: ({ value: e }) => lt(e) ? e.toString() : JSON.stringify(e)
	},
	{
		identify: (e) => typeof e == "number",
		default: !0,
...
function mt(e, t) {
	if (_(e)) for (let n = 0; n < e.items.length; ++n) {
		let r = e.items[n];
		if (!h(r)) {
			if (m(r)) {
				r.items.length > 1 && t("Each pair must have its own sequence indicator");
				let e = r.items[0] || new z(new j(null));
...
var gt = {
	...
	toJSON(e, t) {
		...
		for (let e of this.items) {
			let r, i;
			if (h(e) ? (r = A(e.key, "", t), i = A(e.value, r, t)) : r = A(e, "", t), n.has(r)) throw Error("Ordered maps must not include duplicate keys");
			n.set(r, i);
		}
		return n;
	}
	static from(e, t, n) {
		let r = ht(e, t, n), i = new this();
		return i.items = r.items, i;
	}
};
_t.tag = "tag:yaml.org,2002:omap";
var vt = {
	collection: "seq",
	...
	resolve(e, t) {
		...
		return Object.assign(new _t(), n);
	},
	createNode: (e, t, n) => _t.from(e, t, n)
};
//#endregion
//#region node_modules/yaml/browser/dist/schema/yaml-1.1/bool.js
function yt({ value: e, source: t }, n) {
	return t && (e ? bt : xt).test.test(t) ? t : e ? n.options.trueStr : n.options.falseStr;
}
var bt = {
	identify: (e) => e === !0,
	default: !0,
	...
	test: /^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,
	resolve(e) {
		let t = new j(parseFloat(e.replace(/_/g, ""))), n = e.indexOf(".");
		if (n !== -1) {
...
var Dt = {
	...
	add(e) {
		let t;
		t = h(e) ? e : e && typeof e == "object" && "key" in e && "value" in e && e.value === null ? new z(e.key, null) : new z(e, null), B(this.items, t.key) || this.items.push(t);
	}
	get(e, t) {
		let n = B(this.items, e);
		return !t && h(n) ? g(n.key) ? n.key.value : n.key : n;
	}
	set(e, t) {
	...
	static from(e, t, n) {
		let { replacer: r } = n, i = new this(e);
		if (t && Symbol.iterator in Object(t)) for (let e of t) typeof r == "function" && (e = r.call(t, e, e)), i.items.push(We(e, null, n));
		return i;
	}
};
jt.tag = "tag:yaml.org,2002:set";
var Mt = {
	collection: "map",
	...
	resolve(e, t) {
		if (m(e)) {
			if (e.hasAllNullValues(!0)) return Object.assign(new jt(), e);
...
var Ft = {
	...
	resolve: (e, t, { intAsBigInt: n }) => Nt(e, n),
	stringify: Pt
}, It = {
	identify: (e) => typeof e == "number",
	default: !0,
...
function Ht(e, t, n) {
	...
	if (!i) if (Array.isArray(e)) i = [];
		...
		let e = Array.from(zt.keys()).filter((e) => e !== "yaml11").map((e) => JSON.stringify(e)).join(", ");
	...
	return n && (i = i.concat(R)), i.reduce((e, t) => {
		let n = typeof t == "string" ? Bt[t] : t;
		if (!n) {
			let e = JSON.stringify(t), n = Object.keys(Bt).map((e) => JSON.stringify(e)).join(", ");
...
var Ut = (e, t) => e.key < t.key ? -1 : +(e.key > t.key), Wt = class e {
	constructor({ compat: e, customTags: t, merge: n, resolveKnownTags: r, schema: i, sortMapEntries: a, toStringDefaults: o }) {
		this.compat = Array.isArray(e) ? Ht(e, "compat") : e ? Ht(null, e) : null, this.name = typeof i == "string" && i || "core", this.knownTags = r ? Vt : {}, this.tags = Ht(t, this.name, n), this.toStringOptions = o ?? null, Object.defineProperty(this, s, { value: H }), Object.defineProperty(this, l, { value: Xe }), Object.defineProperty(this, u, { value: W }), this.sortMapEntries = typeof a == "function" ? a : a === !0 ? Ut : null;
	}
	clone() {
...
function Gt(e, t) {
	...
	r && n.push("---");
	let i = Me(e, t), { commentString: a } = i.options;
	if (e.commentBefore) {
...
var Kt = class e {
	constructor(e, t, n) {
		this.commentBefore = null, this.comment = null, this.errors = [], this.warnings = [], Object.defineProperty(this, d, { value: o });
		let r = null;
		...
		this.options = i;
		let { version: a } = i;
		n?._directives ? (this.directives = n._directives.atDocument(), this.directives.yaml.explicit && (a = this.directives.yaml.version)) : this.directives = new O({ version: a }), this.setSchema(a, n), this.contents = e === void 0 ? null : this.createNode(e, r, n);
	}
	clone() {
		let t = Object.create(e.prototype, { [d]: { value: o } });
		return t.commentBefore = this.commentBefore, t.comment = this.comment, t.errors = this.errors.slice(), t.warnings = this.warnings.slice(), t.options = Object.assign({}, this.options), this.directives && (t.directives = this.directives.clone()), t.schema = this.schema.clone(), t.contents = y(this.contents) ? this.contents.clone(t.schema) : this.contents, this.range && (t.range = this.range.slice()), t;
	}
	add(e) {
	...
	createNode(e, t, n) {
		...
		let { aliasDuplicateObjects: i, anchorPrefix: a, flow: o, keepUndefined: s, onTagObj: c, tag: l } = n ?? {}, { onAnchor: u, setAnchors: d, sourceObjects: f } = ce(this, a || "a"), p = {
	...
	deleteIn(e) {
		return ge(e) ? this.contents == null ? !1 : (this.contents = null, !0) : q(this.contents) ? this.contents.deleteIn(e) : !1;
	}
	get(e, t) {
		return v(this.contents) ? this.contents.get(e, t) : void 0;
	}
	getIn(e, t) {
		return ge(e) ? !t && g(this.contents) ? this.contents.value : this.contents : v(this.contents) ? this.contents.getIn(e, t) : void 0;
	}
	has(e) {
		return v(this.contents) ? this.contents.has(e) : !1;
	}
	hasIn(e) {
		return ge(e) ? this.contents !== void 0 : v(this.contents) ? this.contents.hasIn(e) : !1;
	}
	set(e, t) {
		this.contents == null ? this.contents = he(this.schema, [e], t) : q(this.contents) && this.contents.set(e, t);
	}
	setIn(e, t) {
		ge(e) ? this.contents = t : this.contents == null ? this.contents = he(this.schema, Array.from(e), t) : q(this.contents) && this.contents.setIn(e, t);
	}
	setSchema(e, t = {}) {
		...
		switch (e) {
			case "1.1":
				this.directives ? this.directives.yaml.version = "1.1" : this.directives = new O({ version: "1.1" }), n = {
					resolveKnownTags: !1,
					schema: "yaml-1.1"
				};
				break;
			case "1.2":
			case "next":
				this.directives ? this.directives.yaml.version = e : this.directives = new O({ version: e }), n = {
					resolveKnownTags: !0,
					schema: "core"
				};
				break;
		...
		else if (n) this.schema = new Wt(Object.assign(n, t));
	...
	toJS({ json: e, jsonArg: t, mapAsMap: n, maxAliasCount: r, onAnchor: i, reviver: a } = {}) {
		...
		return typeof a == "function" ? k(a, { "": s }, "", s) : s;
	}
	toJSON(e, t) {
		return this.toJS({
			json: !0,
...
function J(e, { flow: t, indicator: n, next: r, offset: i, onError: a, parentIndent: o, startOnNewline: s }) {
...
function Qt(e, t, n) {
	if (t?.type === "flow-collection") {
		let r = t.end[0];
		r.indent === e && (r.source === "]" || r.source === "}") && Zt(t) && n(r, "BAD_INDENT", "Flow end indicator should be more indented than parent", !0);
	}
}
//#endregion
...
function tn({ composeNode: e, composeEmptyNode: t }, n, r, i, a) {
	...
	for (let a of r.items) {
		let { start: l, key: u, sep: d, value: f } = a, p = J(l, {
		...
		if (m) {
			...
			(p.newlineAfterProp || Zt(u)) && i(u ?? l[l.length - 1], "MULTILINE_IMPLICIT_KEY", "Implicit keys need to be on a single line");
		} else p.found?.indent !== r.indent && i(s, "BAD_INDENT", en);
		n.atKey = !0;
		let h = p.end, g = u ? e(n, u, p, i) : t(n, h, l, null, p, i);
		n.schema.compat && Qt(r.indent, u, i), n.atKey = !1, $t(n, o.items, g) && i(h, "DUPLICATE_KEY", "Map keys must be unique");
		let _ = J(d ?? [], {
		...
		if (s = _.end, _.found) {
			...
			n.schema.compat && Qt(r.indent, f, i), s = c.range[2];
			let l = new z(g, c);
...
function nn({ composeNode: e, composeEmptyNode: t }, n, r, i, a) {
	...
	for (let { start: a, value: l } of r.items) {
		...
		n.schema.compat && Qt(r.indent, l, i), s = d.range[2], o.items.push(d);
	}
	return o.range = [
		r.offset,
		s,
...
var an = "Block collections are not allowed within flow collections", on = (e) => e && (e.type === "block-map" || e.type === "block-seq");
function sn({ composeNode: e, composeEmptyNode: t }, n, r, i, a) {
	...
	for (let a = 0; a < r.items.length; ++a) {
		let l = r.items[a], { start: d, key: f, sep: p, value: m } = l, g = J(d, {
			flow: s,
			indicator: "explicit-key-ind",
			next: f ?? p?.[0],
			offset: u,
		...
		if (!g.found) {
			...
			!o && n.options.strict && Zt(f) && i(f, "MULTILINE_IMPLICIT_KEY", "Implicit keys of flow sequence pairs need to be on a single line");
		}
		if (a === 0) g.comma && i(g.comma, "UNEXPECTED_TOKEN", `Unexpected , in ${s}`);
			...
			if (e) {
				...
				h(t) && (t = t.value ?? t.key), t.comment ? t.comment += "\n" + e : t.comment = e, g.comment = g.comment.substring(e.length + 1);
			}
		}
		if (!o && !p && !g.found) {
			let r = m ? e(n, m, g, i) : t(n, g.end, p, null, g, i);
			c.items.push(r), u = r.range[2], on(m) && i(r.range, "BLOCK_IN_FLOW", an);
		} else {
			n.atKey = !0;
			let a = g.end, h = f ? e(n, f, g, i) : t(n, a, d, null, g, i);
			on(f) && i(h.range, "BLOCK_IN_FLOW", an), n.atKey = !1;
			let _ = J(p ?? [], {
				flow: s,
				indicator: "map-value-ind",
				next: m,
			...
			v ? on(m) && i(v.range, "BLOCK_IN_FLOW", an) : _.comment && (h.comment ? h.comment += "\n" + _.comment : h.comment = _.comment);
			let y = new z(h, v);
			if (n.options.keepSourceTokens && (y.srcToken = l), o) {
				let e = c;
				$t(n, e.items, h) && i(a, "DUPLICATE_KEY", "Map keys must be unique"), e.items.push(y);
			} else {
	...
	if (p.length > 0) {
		let e = rn(p, m, n.options.strict, i);
...
function cn(e, t, n, r, i, a) {
	let o = n.type === "block-map" ? tn(e, t, n, r, a) : n.type === "block-seq" ? nn(e, t, n, r, a) : sn(e, t, n, r, a), s = o.constructor;
...
function ln(e, t, n, r, i) {
	...
	if (!a || !o || o === "!" || o === V.tagName && s === "map" || o === U.tagName && s === "seq") return cn(e, t, n, i, o);
	...
	if (!c) {
		...
		else return r ? i(a, "BAD_COLLECTION_TYPE", `${r.tag} used for ${s} collection, but expects ${r.collection ?? "scalar"}`, !0) : i(a, "TAG_RESOLVE_FAILED", `Unresolved tag: ${o}`, !0), cn(e, t, n, i, o);
	}
	let l = cn(e, t, n, i, o, c), u = c.resolve?.(l, (e) => i(a, "TAG_RESOLVE_FAILED", e), t.options) ?? l, d = y(u) ? u : new j(u);
...
function un(e, t, n) {
	let r = t.offset, i = dn(t, e.options.strict, n);
	if (!i) return {
		value: "",
		type: null,
		comment: "",
	...
	let a = i.mode === ">" ? j.BLOCK_FOLDED : j.BLOCK_LITERAL, o = t.source ? fn(t.source) : [], s = o.length;
	...
	for (let e = u; e < s; ++e) {
		...
		a === j.BLOCK_LITERAL ? (d += f + t.slice(c) + r, f = "\n") : t.length > c || r[0] === "	" ? (f === " " ? f = "\n" : !p && f === "\n" && (f = "\n\n"), d += f + t.slice(c) + r, f = "\n", p = !0) : r === "" ? f === "\n" ? d += "\n" : f = "\n" : (d += f + r, f = " ", p = !1);
	}
	switch (i.chomp) {
		case "-": break;
		case "+":
...
function dn({ offset: e, props: t }, n, r) {
...
function pn(e, t, n) {
	...
	switch (i) {
		case "scalar":
			...
			break;
		case "single-quoted-scalar":
			s = j.QUOTE_SINGLE, c = hn(a, l);
			break;
		case "double-quoted-scalar":
			s = j.QUOTE_DOUBLE, c = _n(a, l);
			break;
		/* istanbul ignore next should not happen */
...
function mn(e, t) {
	...
	return n && t(0, "BAD_SCALAR_START", `Plain value cannot start with ${n}`), gn(e);
}
function hn(e, t) {
	return (e[e.length - 1] !== "'" || e.length === 1) && t(e.length, "MISSING_CHAR", "Missing closing 'quote"), gn(e.slice(1, -1)).replace(/''/g, "'");
}
function gn(e) {
	let t, n;
	try {
...
function xn(e, t, n, r) {
	let { value: i, type: a, comment: o, range: s } = t.type === "block-scalar" ? un(e, t, r) : pn(t, e.options.strict, r), c = n ? e.directives.tagName(n.source, (e) => r(n, "TAG_RESOLVE_FAILED", e)) : null, u;
	u = e.options.stringKeys && e.atKey ? e.schema[l] : c ? Sn(e.schema, i, c, n, r) : t.type === "scalar" ? Cn(e, i, t, r) : e.schema[l];
	let d;
	try {
		...
		r(n ?? t, "TAG_RESOLVE_FAILED", a), d = new j(i);
	}
	return d.range = s, d.source = i, a && (d.type = a), c && (d.tag = c), u.format && (d.format = u.format), o && (d.comment = o), d;
}
...
function Cn({ atKey: e, directives: t, schema: n }, r, i, a) {
...
function En(e, t, n, r) {
	...
	switch (t.type) {
		case "alias":
			l = On(e, t, r), (s || c) && r(t, "ALIAS_PROPS", "An alias node must not specify any properties");
			break;
		case "scalar":
		case "single-quoted-scalar":
		case "double-quoted-scalar":
		case "block-scalar":
			l = xn(e, t, c, r), s && (l.anchor = s.source.substring(1));
			break;
		case "block-map":
		case "block-seq":
		case "flow-collection":
			try {
				l = ln(Tn, e, t, n, r), s && (l.anchor = s.source.substring(1));
			} catch (e) {
	...
	return l ??= Dn(e, t.offset, void 0, null, n, r), s && l.anchor === "" && r(s, "BAD_ALIAS", "Anchor cannot be an empty string"), i && e.options.stringKeys && (!g(l) || typeof l.value != "string" || l.tag && l.tag !== "tag:yaml.org,2002:str") && r(c ?? t, "NON_STRING_KEY", "With stringKeys, all keys must be strings"), a && (l.spaceBefore = !0), o && (t.type === "scalar" && t.source === "" ? l.comment = o : l.commentBefore = o), e.options.keepSourceTokens && u && (l.srcToken = t), l;
}
function Dn(e, t, n, r, { spaceBefore: i, comment: a, anchor: o, tag: s, end: c }, l) {
	let u = xn(e, {
		type: "scalar",
		offset: wn(t, n, r),
		indent: -1,
...
function On({ options: e }, { offset: t, source: n, end: r }, i) {
	let a = new ue(n.substring(1));
	...
	let o = t + n.length, s = rn(r, o, e.strict, i);
	return a.range = [
		t,
		o,
		s.offset
...
function kn(e, t, { offset: n, start: r, value: i, end: a }, o) {
	let s = new Kt(void 0, Object.assign({ _directives: t }, e)), c = {
		atKey: !1,
		atRoot: !0,
	...
	l.found && (s.directives.docStart = !0, i && (i.type === "block-map" || i.type === "block-seq") && !l.hasNewline && o(l.end, "MISSING_CHAR", "Block collection cannot start on same line with directives-end marker")), s.contents = i ? En(c, i, l, o) : Dn(c, l.end, r, null, l, o);
	let u = s.contents.range[2], d = rn(a, u, !1, o);
...
var jn = class {
	constructor(e = {}) {
		this.doc = null, this.atDirectives = !1, this.prelude = [], this.errors = [], this.warnings = [], this.onError = (e, t, n, r) => {
			let i = Y(e);
			r ? this.warnings.push(new Yt(i, t, n)) : this.errors.push(new Jt(i, t, n));
		}, this.directives = new O({ version: e.version || "1.2" }), this.options = e;
	}
	decorate(e, t) {
		let { comment: n, afterEmptyLine: r } = An(this.prelude);
		if (n) {
			let i = e.contents;
	...
	streamInfo() {
		return {
			comment: An(this.prelude).comment,
	...
	*next(e) {
		switch (e.type) {
			case "directive":
				...
				break;
			case "document": {
				let t = kn(this.options, this.directives, e, this.onError);
			...
			case "newline":
				...
				break;
			case "error": {
				let t = e.source ? `${e.message}: ${JSON.stringify(e.source)}` : e.message, n = new Jt(Y(e), "UNEXPECTED_TOKEN", t);
				this.atDirectives || !this.doc ? this.errors.push(n) : this.doc.errors.push(n);
				break;
			}
			case "doc-end": {
				if (!this.doc) {
					this.errors.push(new Jt(Y(e), "UNEXPECTED_TOKEN", "Unexpected doc-end without preceding document"));
					break;
				}
				this.doc.directives.docEnd = !0;
				let t = rn(e.end, e.offset + e.source.length, this.doc.options.strict, this.onError);
			...
			default: this.errors.push(new Jt(Y(e), "UNEXPECTED_TOKEN", `Unsupported token ${e.type}`));
		}
	}
	*end(e = !1, t = -1) {
		if (this.doc) this.decorate(this.doc, !0), yield this.doc, this.doc = null;
		else if (e) {
			let e = new Kt(void 0, Object.assign({ _directives: this.directives }, this.options));
...
}, Mn = Symbol("break visit"), Nn = Symbol("skip children"), Pn = Symbol("remove item");
function X(e, t) {
	"type" in e && e.type === "document" && (e = {
		start: e.start,
		value: e.value
	}), Fn(Object.freeze([]), e, t);
}
X.BREAK = Mn, X.SKIP = Nn, X.REMOVE = Pn, X.itemAtPath = (e, t) => {
	let n = e;
	for (let [e, r] of t) {
		let t = n?.[e];
	...
	for (let i of ["key", "value"]) {
		...
		if (a && "items" in a) {
			for (let t = 0; t < a.items.length; ++t) {
				let r = Fn(Object.freeze(e.concat([[i, t]])), a.items[t], n);
				if (typeof r == "number") t = r - 1;
				else if (r === Mn) return Mn;
				else r === Pn && (a.items.splice(t, 1), --t);
			}
...
var Ln = /* @__PURE__ */ new Set("0123456789ABCDEFabcdef"), Rn = /* @__PURE__ */ new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"), zn = /* @__PURE__ */ new Set(",[]{}"), Bn = /* @__PURE__ */ new Set(" ,[]{}\n\r	"), Vn = (e) => !e || Bn.has(e), Hn = class {
	constructor() {
	...
	*parseDocument() {
		...
		switch (e[t]) {
			...
			case "*": return yield* this.pushUntil(Vn), "doc";
			case "\"":
	...
	*parseFlowCollection() {
		...
		switch (i += yield* this.pushIndicators(), r[i]) {
			...
			case "*": return yield* this.pushUntil(Vn), "flow";
			case "\"":
	...
	*parsePlainScalar() {
		...
		for (; r = this.buffer[++n];) if (r === ":") {
			...
			if (Z(r) || e && zn.has(r)) break;
			t = n;
		} else if (Z(r)) {
			let i = this.buffer[n + 1];
			if (r === "\r" && (i === "\n" ? (n += 1, r = "\n", i = this.buffer[n + 1]) : t = n), i === "#" || e && zn.has(i)) break;
			if (r === "\n") {
		...
		loop: for (;;) {
			switch (this.charAt(0)) {
				case "!":
					...
					continue loop;
				case "&":
					e += yield* this.pushUntil(Vn), e += yield* this.pushSpaces(!0);
					continue loop;
				case "-":
				case "?":
				case ":": {
	...
	*pushTag() {
		if (this.charAt(1) === "<") {
			...
			for (; t;) if (Rn.has(t)) t = this.buffer[++e];
			else if (t === "%" && Ln.has(this.buffer[e + 1]) && Ln.has(this.buffer[e + 2])) t = this.buffer[e += 3];
			else break;
...
function Jn(e) {
	if (e.start.type === "flow-seq-start") for (let t of e.items) t.sep && !t.value && !Q(t.start, "explicit-key-ind") && !Q(t.sep, "map-value-ind") && (t.key && (t.value = t.key), delete t.key, Gn(t.value) ? t.value.end ? qn(t.value.end, t.sep) : t.value.end = t.sep : qn(t.start, t.sep), delete t.sep);
}
var Yn = class {
	constructor(e) {
		this.atNewLine = !0, this.atScalar = !1, this.indent = 0, this.offset = 0, this.onKeyLine = !1, this.stack = [], this.source = "", this.type = "", this.lexer = new Hn(), this.onNewLine = e;
	}
	*parse(e, t = !1) {
	...
	*pop(e) {
		...
		if (!t) yield {
			...
			let e = this.peek(1);
			switch (t.type === "block-scalar" ? t.indent = "indent" in e ? e.indent : 0 : t.type === "flow-collection" && e.type === "document" && (t.indent = 0), t.type === "flow-collection" && Jn(t), e.type) {
				case "document":
					e.value = t;
					break;
				case "block-scalar":
			...
			if ((e.type === "document" || e.type === "block-map" || e.type === "block-seq") && (t.type === "block-map" || t.type === "block-seq")) {
				...
				n && !n.sep && !n.value && n.start.length > 0 && Wn(n.start) === -1 && (t.indent === 0 || n.start.every((e) => e.type !== "comment" || e.indent < t.indent)) && (e.type === "document" ? e.end = n.start : e.items.push({ start: n.start }), t.items.splice(-1, 1));
			}
		}
	}
	*stream() {
	...
	*document(e) {
		...
		switch (this.type) {
			case "doc-start":
				Wn(e.start) === -1 ? e.start.push(this.sourceToken) : (yield* this.pop(), yield* this.step());
				return;
			case "anchor":
			case "tag":
			case "space":
			...
			case "comment":
				if (t.value) e.items.push({ start: [this.sourceToken] });
					...
					if (this.atIndentedComment(t.start, e.indent)) {
						...
						if (Array.isArray(n)) {
							qn(n, t.start), n.push(this.sourceToken), e.items.pop();
							return;
						}
					}
		...
		if (this.indent >= e.indent) {
			...
			switch (this.type) {
				...
				case "map-value-ind":
					...
					else if (Gn(t.key) && !Q(t.sep, "newline")) {
...
function Xn(e) {
	...
	return {
		lineCounter: e.lineCounter || t && new Un() || null,
		prettyErrors: t
	};
}
function Zn(e, t = {}) {
	let { lineCounter: n, prettyErrors: r } = Xn(t), i = new Yn(n?.addNewLine), a = new jn(t), o = null;
	for (let t of a.compose(i.parse(e), !0, e.length)) if (!o) o = t;
	else if (o.options.logLevel !== "silent") {
		o.errors.push(new Jt(t.range.slice(0, 2), "MULTIPLE_DOCS", "Source contains multiple documents; please use YAML.parseAllDocuments()"));
		break;
	}
	return r && n && (o.errors.forEach(Xt(e, n)), o.warnings.forEach(Xt(e, n))), o;
}
function Qn(e, t, n) {
	let r;
	...
	let i = Zn(e, n);
	if (!i) return null;
	if (i.warnings.forEach((e) => Ie(i.options.logLevel, e)), i.errors.length > 0) {
...
var $n = { install: (e, t) => {
	...
	title: "OntoPad next ⏩",
	config: Qn(document.querySelector("#ontopad_configuration").text)
});
er.use(r()), er.use(e), er.use($n), er.mount("#app");
//#endregion
